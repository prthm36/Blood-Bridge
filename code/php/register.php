...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO registered_users (name, email, phone, password, bloodgroup, gender, birthdate, weight, state, zipcode, district, area) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    if (!$stmt) {
        die("Error: " . $conn->error);
    }
    $stmt->bind_param("ssssssssssss", $name, $email, $phone, $hashedPassword, $bloodgroup, $gender, $birthdate, $weight, $state, $zipcode, $district, $area);
    if ($stmt->execute()) {
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:8091727833" class="footer-link">8091727833</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:amitbob060@gmail.com" class="footer-link">amitbob060@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
